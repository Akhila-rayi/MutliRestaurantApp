...
class TermsConditions extends StatefulWidget {
  @override
  TermsConditionsState createState() {
  ...
  Widget getPage(){
    ...
    return  BlocListener<AppInfoBloc, AppInfoState>(
        listener: (context, state) {
          ...
          } else if (state is FetchTermsConditionsLoadedState) {
            setState(() {
              showloading = false;
        ...
        child: Stack(children: <Widget>[
          _termslist.length > 0
              ...
              ListView(padding: EdgeInsets.all(8.0), children: [
                  Html(
                      data: _termslist[0].description.toString(),
                      style: {
                        "body": Style(
               ...
               /* Text(
                    _apputils.parseHtmlString(
                        _termslist[0].description.toString()),
  ...
  Future getsaveddata() async{
    ...
    Future.delayed(const Duration(milliseconds: 100), () async {
      ...
      if (isconnected != null && isconnected) {
        _appInfoBloc.add(FetchTermsConditionsEvent());
      } else {
        _apputils.showtoast(
