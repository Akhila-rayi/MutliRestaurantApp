...
class Myfavourites_response_model {
  String status;
  String message;
  List<TodaySpecial> data;

  Myfavourites_response_model({this.status, this.message, this.data});

  Myfavourites_response_model.fromJson(Map<String, dynamic> json) {
    status = json['status'];
